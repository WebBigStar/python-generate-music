class t {
    ...
    once(t, e) {
        const s = this.on(t, e), i = this.on(t, (() => {
            s(), i()
        }));
        return s
    }
...
const s = {lineWidth: 1, labelSize: 11};
...
class i extends e {
    constructor(t) {
        super(t || {}), this.unsubscribe = () => {
            ...
            const e = this.wavesurfer.getWrapper().getBoundingClientRect(), {width: s} = e, i = t.clientX - e.left,
                r = Math.min(1, Math.max(0, i / s)), n = Math.min(s - this.options.lineWidth - 1, i);
            this.wrapper.style.transform = `translateX(${n}px)`, this.wrapper.style.opacity = "1";
            const o = this.wavesurfer.getDuration() || 0;
            this.label.textContent = this.formatTime(o * r);
            const a = this.label.offsetWidth;
            this.label.style.transform = n + a > s ? `translateX(-${a + this.options.lineWidth}px)` : "", this.emit("hover", r)
        }, this.onPointerLeave = () => {
            this.wrapper.style.opacity = "0"
        }, this.options = Object.assign({}, s, t), this.wrapper = document.createElement("div"), this.label = document.createElement("span"), this.wrapper.appendChild(this.label)
    }
    ...
    onInit() {
        ...
        this.wrapper.setAttribute("part", "hover"), Object.assign(this.wrapper.style, {
            position: "absolute",
            zIndex: 10,
            left: 0,
            top: 0,
        ...
        }), this.label.setAttribute("part", "hover-label"), Object.assign(this.label.style, {
            display: "block",
        ...
        s.appendChild(this.wrapper), s.addEventListener("pointermove", this.onPointerMove), s.addEventListener("pointerleave", this.onPointerLeave), this.unsubscribe = () => {
            s.removeEventListener("pointermove", this.onPointerMove), s.removeEventListener("pointerleave", this.onPointerLeave)
        }
    }
